...
public class DatumMountain extends Datum{
    ...
    public DatumMountain(Long timestamp, String idStation, Float temperature, Float pressure, Float humidity, Float rain, Float windModule, String windDirection, Float snowLevel) {
