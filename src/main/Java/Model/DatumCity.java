...
public class DatumCity extends Datum{
    ...
    public DatumCity(Long timestamp, String idStation, Float temperature, Float pressure, Float humidity, Float rain, Float windModule, String windDirection, Float pollutionLevel) {
