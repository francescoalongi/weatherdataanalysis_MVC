...
public class DatumCountry extends Datum {
    ...
    public DatumCountry(Long timestamp, String idStation, Float temperature, Float pressure, Float humidity, Float rain, Float windModule, String windDirection, Float dewPoint) {
